...
<script type="text/html" id="totalTemplate">
		...
		<td><strong><span class="amount">{{grandTotal}}</td>
</script>
								...
								<div class="different-address">
									...
									<div class="order-notes">
										<div class="checkout-form-list">
											...
											<textarea id="comments" cols="30" rows="10" placeholder="<s:message code="label.order.notes.eg" text="Notes for the order or delivery"/>" ></textarea>
										</div>									
									</div>
								</div>
								</c:if>													
									...
									<table id="summary-table"><!-- requires summary-table -->
										...
										<tfoot>
											...
											<tr id="totalRow" class="total-box order-total">
												<th><s:message code="order.total.total" text="Total"/></th>
												<td><strong><span class="amount"><sm:monetary value="${order.orderTotalSummary.total}"/></td>
											</tr>						
										</tfoot>
									</table>
								</div>
								...
								<div class="tab-content">
											...
											<c:forEach items="${paymentMethods}" var="paymentMethod">
												<div
													...
													<c:choose>
														<c:when
															test="${paymentMethod.paymentMethodCode=='stripe'}">
															<c:set var="pageName"
											...
											<input type="hidden" id="paymentMethodType"
												...
												value="<c:if test="${order.paymentType!=null}"><c:out value="${order.paymentType}"/></c:if>" />
